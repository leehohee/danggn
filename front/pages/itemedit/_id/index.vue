        ...
        <v-container fluid>
            ...
            <v-form ref="form" v-model="valid" @submit.prevent="onSubmitForm2">
                ...
                <v-text-field
                    ...
                    :rules="costRules"
                />
                <v-btn type="submit" absolute right>수정하기</v-btn>
...
export default {
    ...
    computed:{
        ...
        mainItems(){
            return this.$store.state.posts.mainItems[0];
        },
    },
    fetch({ store, params }) {
    ...
    mounted() {
        ...
        this.content=this.mainItems.content;
        this.title=this.mainItems.title;
        this.category=this.mainItems.Category.name;
        this.cost=this.mainItems.cost;
        this.modify=this.mainItems.modify;
